...
exports.ManualLeagueOverviewQuery = void 0;
...
var ManualLeagueTeam = new _graphql.GraphQLObjectType({
  ...
  fields: function fields() {
    return {
      ...
      record: {
        type: ManualLeagueTeamRecord,
        resolve: function resolve(team) {
          return team.team_season;
        }
      },
      users: {
        type: new _graphql.GraphQLList(ManualLeagueTeamUser),
        resolve: function resolve(team) {
...
var ManualLeagueDivision = new _graphql.GraphQLObjectType({
  ...
  fields: function fields() {
    return {
      ...
      teams: {
        type: new _graphql.GraphQLList(ManualLeagueTeam),
        resolve: function resolve(division) {
...
var ManualLeagueConference = new _graphql.GraphQLObjectType({
  ...
  fields: function fields() {
    return {
      ...
      divisions: {
        type: new _graphql.GraphQLList(ManualLeagueDivision),
        resolve: function resolve(conference) {
...
var ManualLeagueOverview = new _graphql.GraphQLObjectType({
  ...
  fields: function fields() {
    return {
      ...
      conferences: {
        type: new _graphql.GraphQLList(ManualLeagueConference),
...
exports.ManualLeagueOverviewQuery = ManualLeagueOverviewQuery;
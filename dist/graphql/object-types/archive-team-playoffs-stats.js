...
exports.ArchiveTeamPlayoffsStatsType = undefined;

var _graphql = require('graphql');

var ArchiveTeamPlayoffsStatsType = exports.ArchiveTeamPlayoffsStatsType = new _graphql.GraphQLObjectType({
  name: 'ArchiveTeamPlayoffsStats',
  fields: function fields() {
    return {
      atps_id: { type: _graphql.GraphQLInt },

...
exports.GameNbaMutation = void 0;
...
var GameNbaMutation = {
  addNbaGame: {
    ...
    resolve: function resolve(root, _ref) {
      ...
      return _gameNba["default"].create(input).then(function (game) {
  ...
  deleteNbaGame: {
    ...
    resolve: function resolve(root, _ref2) {
      ...
      return _gameNba["default"].destroy({
        where: {
  ...
  saveNbaPerformances: {
    ...
    args: {
      performances: {
        type: new _graphql.GraphQLList(PlayerPerformanceInput)
      }
    },
    resolve: function resolve(root, _ref3) {
      ...
      return _connection["default"].transaction(function (t) {
        var updates = performances.filter(function (perf) {
          ...
          return _playerPerformance["default"].update(perf, {
            where: {
              id_player_performance: perf.id_player_performance
            },
            transaction: t
          });
...
exports.GameNbaMutation = GameNbaMutation;
